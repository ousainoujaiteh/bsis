            ...
            <div class="row">
                <div class="col-md-6 pull-left">
                    <ol class="breadcrumb" style="background-color: transparent">
                        <li class="active"><a href="{{url('hospitals')}}">Hosptals</a></li>
                    </ol>
                </div>
                <!-- /col-md-5 -->
                <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <ul class="nav nav-pills nav-pills-rose">
                        <li class="active">
                            <a href="#pill1" data-toggle="tab">Hospital</a>
                        </li>
                        <li class="">
                            <a href="#donor" data-toggle="tab">Donors</a>
                        </li><li class="">
                                        ...
                                        <td class="text-right">
                                            <div id="button-dropdown" class="dropdown pull-right">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                    ...
                                                    <li>
                                                        <a  href="{{route('blood_tests.create')}}">
